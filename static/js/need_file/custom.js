 ...
 * <!-- 自定义js代码 -->
 * <script type="text/javascript" src="//域名/usr/extend/custom.js"></script>
 *
 */
...
console.log("\n %c AliceStyle插件 By 萌卜兔\'s | http://racns.com/index.php/374.html","color:#fff;background: linear-gradient(to right , #7A88FF, #d27aff);padding:5px;border-radius: 10px;");
