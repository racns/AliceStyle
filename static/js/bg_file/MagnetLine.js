    ...
    new (function () {
        ...
        return y(e, [{
            ...
            key: "newCanvas", value: function () {
                ...
                return t.style.cssText = "display:block;position:fixed;top:0;left:0;height:100%;width:100%;overflow:hidden;pointer-events:none;z-index:-1;background: #f9f7e6;" + (e = this.c).zIndex + ";opacity:" + e.opacity, t.width = this.el.clientWidth, t.height = this.el.clientHeight, this.el.appendChild(t), t
            }
        }, {
